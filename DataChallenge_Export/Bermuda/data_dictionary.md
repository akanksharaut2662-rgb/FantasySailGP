...
race_dir = Path("Bermuda/boats/Race_1")
...
# Load mark positions
marks = pd.read_csv("Bermuda/marks/Race_1/marks.csv",
                     parse_dates=["DATETIME"])

# Load race metadata
metadata = pd.read_csv("Bermuda/race_metadata.csv")
